...
const options = {
  ...
  apis: [
    path.join(__dirname, 'pages/api/auth/*.ts'),
    path.join(__dirname, 'pages/api/companies/*.ts'),
    path.join(__dirname, 'pages/api/orders/*.ts'),
    path.join(__dirname, 'pages/api/products/*.ts'),
    path.join(__dirname, 'pages/api/customers/*.ts'),
    path.join(__dirname, 'pages/api/inventory/*.ts'),
    path.join(__dirname, 'pages/api/reports/*.ts'),
    path.join(__dirname, 'pages/api/*.ts')
  ]
};

const specs = swaggerJsdoc(options);
fs.writeFileSync(path.join(__dirname, 'public/openapi.json'), JSON.stringify(specs, null, 2));
console.log('Swagger specification generated:', Object.keys(specs.paths || {}));
